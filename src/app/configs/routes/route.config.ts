...
export const routeConfig = [
  ...
  { routeID: segmentConfig.people, leafLink: 'contact', displayName: 'Contacts', nesting: [] },
    ...
    { routeID: segmentConfig.peopleItemShow, leafLink: ':id', displayName: 'Fiche Contact (Afficher)', nesting: [segmentConfig.people] },
      { routeID: segmentConfig.jobPeople, leafLink: 'job', displayName: 'Jobs', nesting: [segmentConfig.peopleItemShow] },
      { routeID: segmentConfig.jobPeopleList, leafLink: 'list', displayName: 'Jobs', nesting: [segmentConfig.peopleItemShow] },
      { routeID: segmentConfig.jobPeopleItem, leafLink: 'item', displayName: 'Job', nesting: [segmentConfig.peopleItemShow] },
      { routeID: segmentConfig.jobPeopleItemAdd, leafLink: 'add', displayName: 'Job (Ajouter)', nesting: [segmentConfig.peopleItemShow] },
      { routeID: segmentConfig.jobPeopleItemEdit, leafLink: ':id/edit', displayName: 'Job (Edition)', nesting: [segmentConfig.peopleItemShow] },
      { routeID: segmentConfig.jobPeopleItemShow, leafLink: ':id', displayName: 'Job (Afficher)', nesting: [segmentConfig.peopleItemShow] },
